...
// exports.getAllSharesForAdmin = catchAsync(async (req, res, next) => {
//   const {
//     search,
//     dateFilter,
//     startDate,
...
//   // Search Filter Logic for Share (name, mobile) and SalePerson (name, email, mobile, userId)
//   if (search) {
//     filter.$or = [
//       { name: { $regex: search, $options: "i" } }, // Share name
//       { mobile: { $regex: search, $options: "i" } }, // Share mobile
//     ];

//     // Skip SalePerson search if salePerson ID is provided (optimization)
//     if (!salePerson) {
//       // Find SalePerson IDs where name, email, mobile, or userId matches the search
...
//   // Fetch shares with filter, pagination, and sorting
//   const shares = await Share.find(filter)
//     .skip(skip)
//     .limit(limit)
//     .sort("-createdAt")
//     .populate("salePerson", "name email mobile userId"); // Populate SalePerson details
